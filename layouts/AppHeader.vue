...
<template>
  <div class="mt-[30px] ml-[100px] mr-[10px]">
    <section class="flex">
      ...
      <nav class="flex ml-auto space-x-[10px]">
        <div>
    ...
    <section>
      <UButton label="Город" @click="city = true" color="white" class="float-right mt-[10px] mr-[30px]"/>
      <UModal v-model="city">
        <UCommandPalette
            v-model="selected"
            multiple
